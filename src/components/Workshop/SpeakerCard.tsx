...
export default function SpeakerCard({ 
  ...
  return (
    <SpotlightCard 
      className="h-full p-6 sm:p-8 flex flex-col group !bg-transparent bg-gradient-to-b from-white/[0.04] to-transparent border border-white/10 border-t-white/20 backdrop-blur-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_8px_32px_rgba(0,0,0,0.4)] rounded-2xl relative overflow-hidden" 
      spotlightColor="rgba(255, 255, 255, 0.15)"
    >
      {/* --- HYPE OVERLAY --- */}
      {!isRevealed && (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-[#030712]/60 backdrop-blur-md rounded-2xl">
      ...
      <div className={`flex flex-col h-full transition-all duration-500 ${!isRevealed ? 'opacity-30 blur-[5px] grayscale select-none pointer-events-none' : ''}`}>
